...
public class AddEditLawyerFragment extends Fragment {
    ...
    public static AddEditLawyerFragment newInstance(String lawyerId) {
        ...
        args.putString(LawyersActivity.EXTRA_LAWYER_ID, lawyerId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mLawyerId = getArguments().getString(LawyersActivity.EXTRA_LAWYER_ID);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Referencias UI
        mSaveButton = (FloatingActionButton) getActivity().findViewById(R.id.fab_addEdit);
    ...
    private void showLawyersScreen(Boolean requery) {
        if (!requery) {
            ToastHelper.ShowMessage(getContext(), "Error al agregar nueva información");
    ...
    private void loadLawyer() {
        // AsyncTask
        if(!TextUtils.isEmpty(mLawyerId)) {
    ...
    private class GetLawyerByIdTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            if (cursor != null && cursor.moveToLast()) {
                Lawyer lawyer = new Lawyer(cursor);
